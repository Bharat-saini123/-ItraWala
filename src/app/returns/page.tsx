...
export default function ReturnsPage() {
  return <LegalPage eyebrow="Our return promise" title="Returns & Refunds" intro="Because fragrance products are personal-use items, we keep returns focused on products that arrive damaged, incorrect, or defective." sections={[
    ...
    { title: "How to request a return", content: "Email hello@itrawala.in with your order number, a short description of the issue, and clear photographs or an unboxing video where available. Our team will review the request and share the next steps, normally within 2 business days." },
