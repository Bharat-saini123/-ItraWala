...
export const metadata = { title: "Terms of Service — तोरणद्वार Itra Wala" };

export default function TermsPage() {
  return <LegalPage eyebrow="Please read" title="Terms of Service" intro="These terms explain the simple rules that apply when you browse तोरणद्वार Itra Wala or place an order with us." sections={[
    ...
    { title: "Intellectual property", content: "The तोरणद्वार Itra Wala name, logo, photography, writing, and other website content belong to तोरणद्वार Itra Wala or our licensors. You may not reproduce, modify, or use them commercially without written permission." },
