...
export const metadata = { title: "Privacy Policy — तोरणद्वार Itra Wala" };
...
export default function PrivacyPolicyPage() {
  return <LegalPage eyebrow="Your privacy" title="Privacy Policy" intro="We respect your trust and collect only the information needed to provide a smooth, reliable shopping experience." sections={[
    { title: "Information we collect", content: "When you create an account, place an order, or contact us, we may collect your name, email address, phone number, delivery address, and order details. Payment information is handled by our payment partners and is not stored by तोरणद्वार Itra Wala." },
    ...
    { title: "Your rights", content: `You may ask us to access, correct, or delete your personal information, subject to records we must retain for legal or business purposes. Email ${process.env.ADMIN_EMAIL ?? ""} for privacy requests and we will respond within a reasonable period.` },
  ]} />;
}