...
export async function sendOrderCreatedEmail(order: OrderEmail) {
  await sendOrderEmail(
    ...
    "Thank you for choosing तोरणद्वार Itra Wala. Your order has been received and we will begin preparing it shortly.",
  );
}
...
<html lang="en">
      ...
      <tr><td align="center">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;background:#fffdf9;border:1px solid #eadcc5;">
          ...
          <tr><td style="padding:34px 32px 10px;">
            ...
            <p style="margin:14px 0 0;color:#574b45;font-size:15px;line-height:1.7;">You have received a new message through the तोरणद्वार Itra Wala website.</p>
          </td></tr>
          ...
          <tr><td style="padding:18px 32px;background:#5c1a28;color:#f6efe3;text-align:center;font-size:12px;line-height:1.6;">
            Crafted with care in Narnaul, Haryana<br /><span style="color:#e4c77e;">तोरणद्वार Itra Wala &middot; Traditional fragrance, thoughtfully delivered</span>
          </td></tr>
        </table>
      </td></tr>
    </table>
  ...
  try {
    await transporter.sendMail({
      from: `तोरणद्वार Itra Wala <${senderEmail}>`,
      to: adminEmail,
    ...
    await transporter.sendMail({
      ...
      subject: "We received your message | तोरणद्वार Itra Wala",
      text: `Hello ${contactData.name},\n\nThank you for contacting तोरणद्वार Itra Wala. We have received your message and our team will get back to you soon.\n\nSubject: ${contactData.subject}\n\nतोरणद्वार Itra Wala | ${adminEmail}`,
      html: `<p>Hello ${escapeHtml(contactData.name)},</p><p>Thank you for contacting तोरणद्वार Itra Wala. We have received your message and our team will get back to you soon.</p><p><strong>Subject:</strong> ${escapedSubject}</p><p>Regards,<br />तोरणद्वार Itra Wala</p>`,
    });
  } catch (error) {
...
<html lang="en">
  <body style="margin:0;background:#f6efe3;color:#241813;font-family:Arial,Helvetica,sans-serif;">
    <div style="display:none;max-height:0;overflow:hidden;opacity:0;">Confirm your तोरणद्वार Itra Wala account</div>
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f6efe3;padding:28px 12px;">
      <tr><td align="center">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;background:#fffdf9;border:1px solid #eadcc5;">
          <tr><td style="height:7px;background:#5c1a28;font-size:0;line-height:0;">&nbsp;</td></tr>
          ...
          <tr><td style="padding:0 32px;"><div style="height:1px;background:#bf9b4f;opacity:.55;"></div></td></tr>
          <tr><td style="padding:34px 32px 10px;">
            <p style="margin:0;color:#5c1a28;font-family:Georgia,serif;font-size:25px;line-height:1.3;">Welcome to तोरणद्वार Itra Wala, ${safeName}</p>
          ...
          <tr><td style="padding:0 32px 30px;color:#766a63;font-size:13px;line-height:1.7;">
            This confirmation link is for your तोरणद्वार Itra Wala account. If you did not create this account, you can safely ignore this email.
          </td></tr>
          <tr><td style="padding:18px 32px;background:#5c1a28;color:#f6efe3;text-align:center;font-size:12px;line-height:1.6;">
            Crafted with care in Narnaul, Haryana<br /><span style="color:#e4c77e;">तोरणद्वार Itra Wala &middot; Traditional fragrance, thoughtfully delivered</span>
          </td></tr>
  ...
  await transporter.sendMail({
    from: `तोरणद्वार Itra Wala <${senderEmail}>`,
    to: email,
    subject: "Confirm your तोरणद्वार Itra Wala account",
    text: `Hello ${customerName || "Customer"},\n\nPlease confirm your तोरणद्वार Itra Wala account by opening this link:\n${actionLink}\n\nIf you did not create this account, you can ignore this email.`,
    html,
  });
}
